...
from .linear import ColumnLinear, RowLinear, RowResidualLinear
...
class AttentionRes(Module):
    ...
    def __init__(self,
        ...
        self.qkv = ColumnLinear(hidden_size,
                                ...
                                tp_size=tp_size,
                                gather_output=False)
        self.dense = RowResidualLinear(hidden_size,
                                       hidden_size,
                                       bias=bias,
                                       dtype=dtype,
                                       tp_group=tp_group,
